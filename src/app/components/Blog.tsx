            ...
            <div className="single-blog-post mb-100">
              ...
              <div className="post-content">
                ...
                <div className="post-meta">
                  <a href="#">
                    <i className="fa fa-clock-o" aria-hidden="true"></i> 20 Jun
                    2018
                  </a>
                  <a href="#">
                    <i className="fa fa-user" aria-hidden="true"></i> Alan
                    Jackson
                  </a>
                </div>
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="single-blog-post mb-100">
              ...
              <div className="post-content">
                <a href="single-post.html" className="post-title">
                  <h5>
                    2018 Midwest Tree and Shrub Conference: Resilient Plants
                    for a Lasting Landscape
                  </h5>
                </a>
                <div className="post-meta">
                  <a href="#">
                  ...
                  <a href="#">
                    <i className="fa fa-user" aria-hidden="true"></i> Christina
                    Aguilera
                  </a>
                </div>
                <p className="post-excerpt">
          ...
          <div className="col-12 col-md-6 col-lg-4">
            <div className="single-blog-post mb-100">
              ...
              <div className="post-content">
                <a href="single-post.html" className="post-title">
                  <h5>
                    The summer coming up, it’s time for both us and the flowers
                    to soak up the sunshine
                  </h5>
                </a>
                <div className="post-meta">
                  <a href="#">
                    <i className="fa fa-clock-o" aria-hidden="true"></i> 19 Jun
                    2018
                  </a>
                  <a href="#">
                    <i className="fa fa-user" aria-hidden="true"></i> Mason
                    Jenkins
                  </a>
                </div>
                <p className="post-excerpt">
